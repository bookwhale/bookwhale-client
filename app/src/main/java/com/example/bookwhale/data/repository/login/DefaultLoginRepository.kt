...
class DefaultLoginRepository(
    ...
    override suspend fun getNaverLoginInfo(code: String): LoginModel = withContext(ioDispatcher) {
    ...
    override suspend fun getKaKaoLoginInfo(code: String): LoginModel = withContext(ioDispatcher) {
